...
module.exports = function (app) {
  ...
  app.delete("/api/users/:id", function (req, res) {
    db.User.destroy({
      ...
      // Redirect unregistered user to home page
      res.redirect("/");
    });
  });
  // Route to redirect all invalid URL inputs to the homepage - included here because it's the last routing file included in server.js
